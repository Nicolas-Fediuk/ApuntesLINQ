...
var agrupamientoPorSolteria = Personas.GroupBy(x => x.Soltero);

foreach(var soltero in agrupamientoPorSolteria)
{
    Console.WriteLine($"Personas donde soltero esta en {soltero.Key}");
    foreach(var nombre in soltero)
    {
